...
const Single_post = () => {
	...
	const pid = router.query.single_term;
						...
						.map((item) => {
							...
							return (
								<div className="container" key={id}>
									<header className="mx-auto mb-16 max-w-lg text-center">
										...
										<div className="inline-flex items-center">
											<img
												src={authorImage}
												alt="author"
												className="mr-4 h-12 w-15 shrink-0"
											/>
										...
										<h1 className="font-display text-jacarta-700 mb-4 mt-10 text-2xl dark:text-white sm:text-5xl">
											{title}
										</h1>
										{/* <!-- Author --> */}
									...
									{/* <img src={image} alt="post 1" className="rounded  items-center " width="60%" style={{marginLeft: "20%"}}/> */}
									...
									<article className="mb-12">
										...
										<div className="article-content">
											<blockquote className="text-jacarta-700 !my-10 text-xl italic dark:text-white">
												<span className="animate-gradient">Cardano Definition</span>
											...
											<blockquote className="text-jacarta-700 !my-10 text-xl italic dark:text-white">
												<span className="animate-gradient">Ethereum Definition</span>
												<cite className="text-jacarta-400 text-2xs mt-3 block not-italic tracking-tight">
												</cite>
											</blockquote>
											<p className='text-normal-case'  style={{textTransform: 'none'}}>
									...
									<div className="mx-auto max-w-[48.125rem]">
										...
										{/* <!-- Posts --> */}
										<News_item
											data={single_news_data.slice(1, 3)}
